        ...
        <section class="Lokasi Klinik section">
            <div class="container">
                <div class="row d-flex align-items-center">
                    ...
                    <!-- Kolom gambar -->
                    <div class="col-md-6">
                        <img src="img/dokum.png" class="d-block w-100 mt-2" alt="Gambar Dokter">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section">
            ...
            @endif
                ...
                <div class="container mt-5">
                    <div class="col-md-6">
                        <form id="reservation" action="{{ route('regist.submit')}}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                                ...
                                <input type="text" name= "no_reg" class="form-control" placeholder="No Registrasi" required>
                            </div>
